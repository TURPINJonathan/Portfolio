...
class ModulesFixtures extends Fixture
{
    ...
    private function addModuleIfNotExists(ObjectManager $manager, string $name, string $icon, array $options, bool $isAdminModule): void
    {
        ...
        if (!$existingModule) {
            ...
            $module->setIsAdminModule($isAdminModule);
